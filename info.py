...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002935370332')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/CinemaMovie_Hind')  # Support group link (make sure bot is admin)
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/+JFFFSmhuBulkOGMy")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/+JFFFSmhuBulkOGMy")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/+JFFFSmhuBulkOGMy")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "2575f04177b19cc1b4613109c4e89ec1f0f0984d") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "https://linkshortify.com/api") # Shortener website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+Fk74niLgb4A1NjE0') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Skyhdhub') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/CinemaMovie_Hindi') # Update channel link for the bot
...
FQDN = "auto-f-d9e3bf8ef623.herokuapp.com"
